...
/**
 * Created by ${wild00wolf} on 2016/11/23.
 */
public class NewsFragment extends BaseMvpFragment<GirlsItemView, GirlsItemPresenter> implements GirlsItemView, SwipeRefreshLayout.OnRefreshListener {
